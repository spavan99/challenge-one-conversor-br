...
public class Teclado extends JPanel implements ActionListener {
	...
	// tirar
	private static final Teclado instancia = new Teclado();
...
//	private void montaTeclado(Color cor) {
	...
	public void montaTeclado(Color cor) {
	    ...
	    GridBagLayout  tclayout = new GridBagLayout();
	    ...
	    adcionaBtnTec( "3", gbl.COR_CONTRASTE, c, 2, 3);
