...
public class appMenuSwing extends JPanel implements ActionListener{
	...
	public appMenuSwing() {
		...
		adcionaItensMenu( "Pesos", gbl.COR_CLARA);
	...
	public void actionPerformed(ActionEvent e) {
		if( e.getSource() instanceof JButton) {
			...
			if( txtbotao.contains("MOEDA")){
                ...
                // cria classe moeda somente passar nivel o outro muda fluxo e a classe
				// ver como colocar classe generica 
                cmoedas = new Moedas(); 
                //cimc = new IMC(); 
    			appDadosSwing moedas = new appDadosSwing( cmoedas, "IMC" );
	
    			 // exemplo do useo tavela...
