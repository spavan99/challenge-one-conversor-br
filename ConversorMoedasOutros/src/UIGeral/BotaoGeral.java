...
public class BotaoGeral extends JButton {
	...
	public BotaoGeral(String msg, Color corfundo, Color cortxt, int tamfonte, String fonte) {
	...
	public BotaoGeral(String pmsg, Color pcorfundo) {
 		this.padmsg = pmsg;
 		this.corfundo = pcorfundo;
 		config();
	}	

	public BotaoGeral(String pmsg, Color pcorfundo, int tamfonte) {
 		this.padmsg = pmsg;
 		this.corfundo = pcorfundo;
 		this.tamfonte = tamfonte;
 		config();
	}
	public BotaoGeral(String pmsg) {
